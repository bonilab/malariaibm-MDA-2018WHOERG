...
#    print(ytick_labels)
    ...
    ax[idx,0].text(dt.date(2020, 6, 1), 0.3, figure_index[idx*3], fontsize=32, weight='bold')
    ax[idx,1].text(dt.date(2020, 6, 1), 0.3, figure_index[idx*3+1], fontsize=32, weight='bold')
    ax[idx,2].text(dt.date(2020, 6, 1), 0.3, figure_index[idx*3+2], fontsize=32, weight='bold')
...
#%%
ax[0,3].text(dt.date(2020, 6, 1), 0.11, figure_index[0*3+3], fontsize=32, weight='bold')
ax[1,3].text(dt.date(2020, 6, 1), 0.5, figure_index[1*3+3], fontsize=32, weight='bold')
ax[2,3].text(dt.date(2020, 6, 1), 0.1, figure_index[2*3+3], fontsize=32, weight='bold')
ax[3,3].text(dt.date(2020, 6, 1), 0.5, figure_index[3*3+3], fontsize=32, weight='bold')
