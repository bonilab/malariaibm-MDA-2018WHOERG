...
#    print(ytick_labels)
    ...
    ax[idx,0].text(dt.date(2020, 6, 1), 0.45, figure_index[idx*3], fontsize=25, weight='bold')
...
#%%
ax[0,3].text(dt.date(2020, 6, 1), 0.001, figure_index[0*3+3], fontsize=25, weight='bold')
ax[1,3].text(dt.date(2020, 6, 1), 0.7, figure_index[1*3+3], fontsize=25, weight='bold')
ax[2,3].text(dt.date(2020, 6, 1), -0.002, figure_index[2*3+3], fontsize=25, weight='bold')
ax[3,3].text(dt.date(2020, 6, 1), 0.6, figure_index[3*3+3], fontsize=25, weight='bold')
